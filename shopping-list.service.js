...
var ShoppingListService = (function () {
    ...
    ShoppingListService.prototype.getItems = function () {
        return mock_component_1.shopping_list;
    };
    ShoppingListService.prototype.insertItem = function (item) {
        mock_component_1.shopping_list.push(item);
    };
    ShoppingListService.prototype.deleteItem = function (item) {
        mock_component_1.shopping_list.splice(mock_component_1.shopping_list.indexOf(item), 1);
    };
